<%-- 
    Document   : index
    Created on : 24/10/2025, 08:35:53 AM
    Author     : dell
--%>

<html>
    <head>
        <title>Pagina  Garrido Aplicación WEB Software JSP - MySQL </title>
        <meta charset="UTF-8">
...
<br>
        <div class="container">
            <center>
                ...
                <h4>LISTA OFICIAL DE USARIOS DE SISTEMA Garrido</h4>
                <br>
            </center>  
                ...
                <table class="table table-striped table-bordered table-hover" style="text-align: center">
                    ...
                    <tbody>
                        ...
                        %>  
                        <tr>
                            <td><%=rs.getString("id_usuarios")%></td>
                            <td><%=rs.getString("usuario")%></td>
                            <td><%=rs.getString("password")%></td>
                            
                            <td><a class="btn btn-primary" href="eliminar.jsp?id_usuario=<%=rs.getString("id_usuarios")%>">Eliminar</a></td>
                        ...
                        <div class="col-md-3 col-xs-6">
                            <div class="footer">
                                ...
                                <ul class="footer-links">
                                        ...
                                        <li><i class="fa fa-envelope-o"></i>Aristeo Garrido</li>
                                </ul>
                            </div>
