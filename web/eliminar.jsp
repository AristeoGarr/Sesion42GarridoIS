<%-- 
    ...
    Created on : 24/10/2025, 09:34:39 AM
    Author     : dell
--%>

<html>
    <head>
        <title>Pagina Eliminar Garrido Aplicacion WEB </title>
        <meta charset="UTF-8">
            ...
            <div class="row">
                ...
                <div class="col-md-4 order-details">
                    ...
                    <div class="form-group">
                        ...
                        <input class="input" type="text" value="<%= id_usuario%>" required name="id_usuarios">
                    </div>
