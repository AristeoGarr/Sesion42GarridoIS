<%-- 
    ...
    Created on : 24/10/2025, 09:52:01 AM
    Author     : dell
--%>

<html>
    <head>
        <title>Pagina Editar Garrido Aplicacion WEB </title>
        <meta charset="UTF-8">
...
<!-----------------------------/BOOTSTRAP----------------------------->
    ...
    <body style="background-color: #c0a16b">
        <!-- HEADER -------------------------------------------------------------------->
                <header>
                        <!-- MAIN HEADER -->
                        <div id="header">
...
<!-- /SECTION -->
   ...
   ps =conexion.prepareStatement("update tusuarios set usuario='" + usuario + "', password='" + password + "' where id_usuarios='"+id_usuario+"';");
                         ps.executeUpdate();
